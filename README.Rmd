...
There is **massive** overhead in the translated version. I believe this is caused by assigning to variables where the environment is explicitly specified rather than just assigning to variables in the local environment. Simpler translations were faster. I'm working on improving this!
